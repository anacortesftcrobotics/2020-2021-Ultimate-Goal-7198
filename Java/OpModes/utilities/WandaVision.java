...
public class WandaVision {
    ...
    private static final String VUFORIA_KEY =
            "";
    ...
    VuforiaTrackable blueTowerGoalTarget,blueAllianceTarget;
    VuforiaTrackable redTowerGoalTarget,redAllianceTarget;
    VuforiaTrackable frontWallTarget;
    List<VuforiaTrackable> allTrackables;
    
    // Constructor
    WandaVision(UGRobot _robot) {
        // Set robot reference
        robot = _robot;
        /*
         * Retrieve the camera we are to use.
         */
        webcamName = robot.hardwareMap.get(WebcamName.class, "WebcamHub");
